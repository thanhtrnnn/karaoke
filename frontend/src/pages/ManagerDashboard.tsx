...
export default function ManagerDashboard() {
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto w-full space-y-6">
      <div className="flex justify-between items-center"><h1 className="font-h1 text-white">Dashboard - Quản lý chi nhánh</h1><p className="text-slate-400 font-body-md">{formatDate(new Date())}</p></div>
      {/* KPI Cards */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Đơn F&B', value: summary?.orders?.toString() || '0', icon: 'receipt_long', color: 'tertiary' },
